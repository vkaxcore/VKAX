...
public:
    ...
    */
    ...
    static constexpr CAmount GetCollateralAmount() { return GetSmallestDenomination() / 10000; }
    static constexpr CAmount GetMaxCollateralAmount() { return GetCollateralAmount() * 20; }
