    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"debug",
                ...
                " - \"springbok\" activates all SPRINGBOK-specific categories at once;\n"
            ...
            "  result               (string) \"Debug mode: \" followed by the specified category.\n"
                ...
                RPCExamples {
                    HelpExampleCli("debug", "springbok")
            + HelpExampleRpc("debug", "springbok+net")
            }}.ToString());
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given springbok address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The springbok address to validate"},
                },
                RPCResult{
            "{\n"
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The springbok address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "springbok-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* SPRINGBOK features */
    { "springbok",               "mnsync",                 &mnsync,                 {} },
    { "springbok",               "spork",                  &spork,                  {"arg0","value"} },
