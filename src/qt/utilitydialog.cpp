    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  springbok-qt [command-line options]                     \n";
...
All the SPRINGBOK in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 SPRINGBOK, 0.01 SPRINGBOK, 0.1 SPRINGBOK, 1 SPRINGBOK and 10 SPRINGBOK -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%2\" href=\"%3\">%1 documentation</a>."
        ...
        .arg("https://docs.springbok.xyz/en/stable/wallets/springbokcore/coinjoin-instantsend.html")
        );
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
