...
"""Verify that starting springbokd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start springbokd with -h for help text")
        ...
        self.log.info("Start springbokd with -version for version information")
        ...
        self.log.info("Start springbokd with -fakearg to make sure it does not start")
