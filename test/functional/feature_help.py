...
"""Verify that starting vkaxd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vkaxd with -h for help text")
        ...
        self.log.info("Start vkaxd with -version for version information")
        ...
        self.log.info("Start vkaxd with -fakearg to make sure it does not start")
