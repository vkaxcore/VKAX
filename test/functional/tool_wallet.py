...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def dash_wallet_process(self, *args):
        binary = self.config["environment"]["BUILDDIR"] + '/src/springbok-wallet' + self.config["environment"]["EXEEXT"]
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `springbok-wallet help` raises an error. Use `springbok-wallet -help`.
