...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 SPRINGBOK from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 10000000 SPRINGBOK in block rewards plus fees, but
        ...
        # Send 100 SPRINGBOK with subtract fee from amount
        ...
        # Sendmany 100 SPRINGBOK with subtract fee from amount
        ...
        # This will raise an exception for attempting to get the private key of an invalid SPRINGBOK address
        assert_raises_rpc_error(-5, "Invalid SPRINGBOK address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid SPRINGBOK address
        assert_raises_rpc_error(-5, "Invalid SPRINGBOK address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid SPRINGBOK address or script", self.nodes[0].importaddress, "invalid")
