...
define $(package)_config_cmds
  # NOTE: prefix must be the depends host prefix so DESTDIR staging lands in ${staging_dir}/${host_prefix}
...
define $(package)_stage_cmds
  # install headers/libs into staging; we’ll normalize layout in postprocess
