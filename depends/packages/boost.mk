...
# Detect CPU cores (macOS, Linux)
ifndef nproc
nproc := $(shell sysctl -n hw.ncpu 2>/dev/null || nproc 2>/dev/null || echo 4)
endif

define $(package)_set_vars
  # Build type and layout
  ...
  # Toolset preference (clang if present)
...
# Generate user-config.jam. On Android we must pin <target-os>android so b2 does not retarget to linux.
...
# Build. Wipe bin.v2 on Android to avoid stale host leaks across matrix runs.
...
# =============================================================================
# End of file: depends/packages/boost.mk
# =============================================================================
