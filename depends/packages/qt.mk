...
fix_no_printer.patch fix_riscv64_arch.patch xkb-default.patch no-xlib.patch \
fix_android_qmake_conf.patch fix_android_jni_static.patch dont_hardcode_pwd.patch \
freetype_back_compat.patch drop_lrelease_dependency.patch fix_powerpc_libpng.patch \
...
define $(package)_build_cmds
  $(MAKE) -C qtbase -j$(NPROC)
  $(MAKE) -C qttools/src/linguist/lrelease -j$(NPROC)
  $(MAKE) -C qttools/src/linguist/lupdate -j$(NPROC)
  $(MAKE) -C qttranslations -j$(NPROC)
endef
