...
$(package)_config_opts += -no-compile-examples -no-cups -no-egl -no-eglfs -no-freetype -no-gif -no-glib -no-icu -no-ico -no-iconv -no-kms -no-linuxfb -no-libudev -no-mtdev -no-openvg -no-reduce-relocations -no-qml-debug
...
$(package)_config_opts += -no-feature-lcdnumber -no-feature-pdf -no-feature-printdialog -no-feature-printer -no-feature-printpreviewdialog -no-feature-printpreviewwidget
$(package)_config_opts += -no-feature-sessionmanager -no-feature-sql -no-feature-statemachine -no-feature-syntaxhighlighter -no-feature-textbrowser
$(package)_config_opts += -no-feature-textodfwriter -no-feature-topleveldomain -no-feature-udpsocket -no-feature-undocommand -no-feature-undogroup
$(package)_config_opts += -no-feature-undostack -no-feature-undoview -no-feature-vnc -no-feature-wizard -no-feature-xml
...
$(package)_config_opts_linux=-qt-xkbcommon-x11 -qt-xcb -no-xcb-xlib -no-feature-xlib -system-freetype -fontconfig -no-opengl -dbus-runtime
