...
# VKAX — miniupnpc static build for Android cross; PIC + deterministic toolchain/env; headers into include/miniupnpc, lib into lib. — Setvin
package=miniupnpc
...
define $(package)_set_vars
  # ensure PIC for Android; wire AR/RANLIB explicitly for reproducibility
  $(package)_cflags+=-fPIC
  $(package)_build_opts=CC="$($(package)_cc)" AR="$($(package)_ar)" RANLIB="$(host_RANLIB)"
